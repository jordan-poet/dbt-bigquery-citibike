...
then applies the clean_citibike_ingest_casting_nospace macro to cast data types. 
*/
...
{% if model_names | length > 0 %}
    ...
    (
    {{ clean_citibike_staging_nospace(model_name) }} --calls data cleaning macro applying data typing
    )
